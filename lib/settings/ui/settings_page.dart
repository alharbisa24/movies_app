        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              verticalSpace(20),
              _buildLanguageOption(AppLocale.english.getString(context), 'en', isDark).animate().fadeIn(duration: 600.ms).slideY(begin: 0.3, end: 0, duration: 400.ms),
              _buildLanguageOption(AppLocale.arabic.getString(context), 'ar', isDark).animate().fadeIn(duration: 600.ms).slideY(begin: 0.3, end: 0, duration: 400.ms),
              verticalSpace(16),
            ],
          ),
        );
